...
import { Play, Trophy, Code2, GraduationCap, User, Check, X } from 'lucide-react';
      ...
      >
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <button
            ...
            style={{ width: '100%', padding: '0.65rem', fontSize: '0.78rem', fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}
          >
            <GraduationCap className="w-4 h-4" />
            <span>C# Otomasyon Akademisi Görevleri</span>
          </button>
        </div>
      </div>
    </div>
